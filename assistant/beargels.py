...
REPLY_PERSONA = (
    ...
    "- 닉네임 뒤 줄바꿈 후 본문. **분량이 곧 정성이다 — 주어진 글자수를 최대한 "
    "꽉 채워 길게 쓴다**(쿠팡 300자, 배민 1000자 이내). 단 같은 말 반복·복붙 "
    "군더더기는 금지. 주문한 메뉴 하나하나·식감·상황·감사·계절 안부·(불만이면) "
    "구체적 개선까지 진짜 내용으로 풍성하게 채운다.\n"
    ...
    "다음에 또 주문 주세요 😊\"\n"
    "★5 3번째 → \"이우님,\\n벌써 세 번째네요, 기억해주고 또 주문해주셔서 진짜 "
    "감사해요 ㅎㅎ 다음에도 맛있게 구워둘게요!\""
)
...
# 사장님 방침: '분량 = 정성' → 최대한 꽉 채워 쓴다.
#  · 쿠팡: 입력창 하드 제한 300자 → target 295.
#  · 배민: 입력창 maxlength 미설정. 사장님 지정 1000자까지 꽉 채움 → target 950.
PLATFORM_REPLY = {
    "baemin":  {"label": "배민",     "max_len": 1000, "target_len": 950},
    "coupang": {"label": "쿠팡이츠", "max_len": 300, "target_len": 295},
}
...
_THANKS_VARIANTS = (
    ...
    "덕분에 오늘도 신나게 구웠어요~ 다음에 또 주문 주세요",
    "맛있게 드셨다니 진짜 다행이에요! 다음에도 맛있게 구워둘게요",
