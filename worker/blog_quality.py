...
- **줄 리듬을 지킨다**: 한 줄에 한 문장(15~35자), 문단은 빈 줄로 나눈다. 긴 문장을 한 줄에 몰지 마라.
  `> ` 로 시작하는 인용 줄과 `**…**` 로 감싼 강조 줄(절마다 하나)은 그 형식 그대로 둔다.
- 말투는 **운영자 일기체**(매장을 운영하는 사장님이 오늘 매장에서 있었던 일을 적듯: "오늘 매장에서는…",
  "저희가 준비한…", "손님들이…"). 손님인 척("다녀왔어요") 쓰지 않는다.
